    ...
    <body>
        ...
        <?php
            ...
            $query1 = "SELECT ECHIPA1ID, ECHIPA2ID, DENUMIRE, ECHIPA1SCOR, ECHIPA2SCOR, SCOR1PEN, SCOR2PEN, DATAMECI, TIPMECI
                        ...
                        WHERE ECHIPA1ID = (SELECT ECHIPAID FROM ECHIPE WHERE (DENUMIRETARA = '".$echipa1."')) AND ECHIPA2ID = (SELECT ECHIPAID FROM ECHIPE WHERE (DENUMIRETARA = '".$echipa2."'))";
