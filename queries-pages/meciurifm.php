    ...
    <body>
        ...
        <table class="meniu">
			<tr>
				...
				<td> <a class="buttonClicked" href="meciuri.php"> MECIURI </td>
        ...
        <table class="meniu">
			<tr>
				<td> <a class="button" href="meciurio.php"> OPTIMI </td>
				<td> <a class="button" href="meciuris.php"> SFERTURI </td>
                <td> <a class="button" href="meciurisf.php"> SEMIFINALE </td>
                <td> <a class="buttonClicked" href="meciurifm.php"> FINALA MICA </td>
